class QueueItem {
  ...
  public void Init(int data, QueueItem next, QueueItem prev) {
    this.data = data;
    this.next = next;
    next.prev = this;
    this.prev = prev;
  ...
  public QueueItem GetPrev() { return prev;}
  public void SetNext(QueueItem n) { next = n;}
  public void SetPrev(QueueItem p) { prev = p;}
}
